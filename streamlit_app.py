...
def preparar_remision(pedido):
    ...
    if not pedido.get("emisor_remision") or not all(pedido["emisor_remision"].values()):
        pedido["emisor_remision"] = dict(st.session_state.get("emisor_remision", {}))
    pedido.setdefault("estado_pago", "Por confirmar")
...
with st.sidebar:
    ...
    with st.expander("Datos del emisor para Factura / remisión", expanded=False):
        ...
        for campo, etiqueta in [("nombre", "Nombre completo o razón social"), ("rfc", "RFC del emisor"),
                                ...
                                ("lugar", "Municipio y estado de expedición"), ("cp", "Código postal de expedición")]:
            emisor_nuevo[campo] = st.text_input(etiqueta, value=emisor_config.get(campo, ""),
                                               key=f"remision_emisor_{campo}").strip()
        emisor_nuevo["rfc"] = emisor_nuevo["rfc"].upper()
        st.session_state["emisor_remision"] = emisor_nuevo
        if not all(emisor_nuevo.values()):
            st.info("El documento mostrará BORRADOR mientras falten datos del emisor.")
        st.caption("La nota de remisión no sustituye la factura fiscal (CFDI).")
...
ALIASES_PRODUCTOS = {
    ...
    "lechugas en bolsa": "bolsa lechuga",
        # Chile verde = chile de arbol verde
    "chile verde": "chile de arbol verde",
    "chiles verdes": "chile de arbol verde",
    "ch verde": "chile de arbol verde",
    "ch. verde": "chile de arbol verde",
    "chile v": "chile de arbol verde",
    "verde": "chile de arbol verde",

    # Plátano Tabasco
    "platano tabasco": "platano",
    "plátano tabasco": "platano",
    "platano tabasco": "platano",
    "platanos tabasco": "platano",
    "plátanos tabasco": "platano",
    "plat tabasco": "platano",
    "tabasco": "platano",

    # Naranja Valencia
    "naranja sin semilla": "naranja valencia",
    "naranjas sin semilla": "naranja valencia",
    "naranja sin semillas": "naranja valencia",
    "naranjas sin semillas": "naranja valencia",
    "naranja s/s": "naranja valencia",
    "naranjas s/s": "naranja valencia",
    "naranja ss": "naranja valencia",
    "naranjas ss": "naranja valencia",

    # Chile morrón = pimiento
    "chile morron": "pimiento",
    "chile morrón": "pimiento",
    "chiles morron": "pimiento",
    "chiles morrón": "pimiento",
    "morron": "pimiento",
    "morrón": "pimiento",
    "ch morron": "pimiento",
    "ch morrón": "pimiento",
    "ch. morron": "pimiento",
    "ch. morrón": "pimiento",
    "morron rojo": "pimiento",
    "morrón rojo": "pimiento",
    "morron verde": "pimiento",
    "morrón verde": "pimiento",
    "morron amarillo": "pimiento",
    "morrón amarillo": "pimiento",

    # Nuez de Brasil
    "nuez de brasil": "nuez de brasil",
    "nuez brasil": "nuez de brasil",
    "nuez brasileña": "nuez de brasil",
    "nuez brasilera": "nuez de brasil",
    "nuez brasilero": "nuez de brasil",
    "nuez brasil": "nuez de brasil",
    "nueces de brasil": "nuez de brasil",
    "nueces brasil": "nuez de brasil",
    "brasil": "nuez de brasil",

    # Papas botana
    "papas botana": "papas botana",
    "papa botana": "papas botana",
    "papas para botana": "papas botana",
    "papa para botana": "papas botana",
    "papa botanera": "papas botana",
    "papas botaneras": "papas botana",
    "botana": "papas botana",
    ...
    "platano macho": "platano macho",
    "platanos macho": "platano macho",
    "plátanos macho": "platano macho",
    "plat macho": "platano macho",
    "plat. macho": "platano macho",
    "macho": "platano macho",

    # Ajonjolí garapiñado
    "ajonjoli garapiñado": "AJONJOLI GARP",
    "ajonjolí garapiñado": "AJONJOLI GARP",
    "ajonjoli garapinado": "AJONJOLI GARP",
    "ajonjolí garapinado": "AJONJOLI GARP",
    "ajonjolis garapiñados": "AJONJOLI GARP",
    "ajonjolís garapiñados": "AJONJOLI GARP",
    "ajonjolis garapinados": "AJONJOLI GARP",
    "ajonjolís garapinados": "AJONJOLI GARP",
    "garapiñado de ajonjoli": "AJONJOLI GARP",
    "garapiñado de ajonjolí": "AJONJOLI GARP",
    "garapiñado ajonjoli": "AJONJOLI GARP",
    "garapiñado ajonjolí": "AJONJOLI GARP",
    "ajonjoli g": "AJONJOLI GARP",
    "ajonjolí g": "AJONJOLI GARP",
